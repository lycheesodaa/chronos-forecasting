...
def parse_args() -> argparse.Namespace:
	parser = argparse.ArgumentParser(description="Fine-tune Chronos-2 for demand_aus, then rolling-evaluate.")
	parser.add_argument("--config-file", type=str, default="./configs/demand_aus_datasets.yaml")
	parser.add_argument("--name", type=str, default=None)
	parser.add_argument("--output-dir", type=str, default="./outputs/chronos2/demand_aus_finetune")
