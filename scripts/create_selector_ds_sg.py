...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--predictions-dir", type=str, default="./outputs/chronos2/demand_sg")
    parser.add_argument("--output-csv", type=str, default="./outputs/chronos2/demand_sg_contexts_mse.csv")
